...
import 'package:log_custom_printer/src/view/console/notifier/log_console_notifier.dart';
...
class ConsoleProvider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListenableProvider<LogConsoleNotifier>(
      create: (context) =>
          LogConsoleNotifier(logPrinterService: fetchLogPrinterService()),
      child: ConsoleWidget(),
    );
  }
}
...
class ConsoleWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final logs = context.read<LogConsoleNotifier>();
    return Container(
