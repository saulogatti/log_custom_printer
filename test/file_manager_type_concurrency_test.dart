...
void main() {
  group('FileManager concurrency safety', () {
    ...
    setUp(() async {
      tempDir = await Directory.systemTemp.createTemp('file_manager_concurrency_test');
    });
    ...
    test('serializes concurrent writes on the same log file without losing entries', () async {
